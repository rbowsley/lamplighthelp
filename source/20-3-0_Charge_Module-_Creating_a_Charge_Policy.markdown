...
- The order of the rules is important. Rules will be applied in the order that they are listed, so for example if you add a flat-rate rule of £50 as the last in the list, all the other rules that appear earlier will be ignored. 
