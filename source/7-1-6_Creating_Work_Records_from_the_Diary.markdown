...
#### View full details
This will open up the record so that you can see all the information recorded in it on one page.
#### Edit
...
#### Add {{outcome}}s
This will open up an {{outcome}} record for everyone included in the attendance table. For more on adding {{outcome}} records, see [8.1.0 Adding {{Outcome}}s from the Main Menu Bar](/help/index/p/8.1.0).
